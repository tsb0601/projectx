...
class SiglipVisionTower(ClipVisionTower):
    ...
    def load_model(self, device_map=None):
        ...
        elif self.vision_tower_name in ("timm/ViT-L-16-SigLIP-384", "siglip/CLIP-ViT-L-16-384"):
            clip_model, processor = create_model_from_pretrained('hf-hub:timm/ViT-L-16-SigLIP-384')
            # self.image_processor = ProcessorWrapper(processor, height=384, width=384)
        else:
