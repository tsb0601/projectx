...
export CKPT_NAME="TPU-llava-v1.5-7b-finetune-737k-hybrid-clip-siglip-withpretrain-unpad"
...
python llava/train/train_tpu.py \
    ...
    --vision_tower hybridmodel-siglip/CLIP-ViT-SO400M-14-384-and-openai/clip-vit-large-patch14-336 \
