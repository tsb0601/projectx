...
export CKPT_NAME="TPU-llava-v1.5-7b-finetune-737k-hybrid-dino-ijepa-supervised"
...
python llava/train/train_tpu.py \
    ...
    --vision_tower hybridmodel-ijepa-vit-g-16-and-facebook/dinov2-giant-res384-and-supervised-vit-h-14-in21k \
